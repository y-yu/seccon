...
これでログインして\Mercuryを占領しているプロセスを殺す戦略だ。
...
奴等我々の収入を減らすために、
あえて他のチームのフラッグワードを\Mercuryに書き込んだに違いない。
こうすることで、我々が\Mercuryから得られるポイントは五分ごとに2ポイントになってしまった。
...
\Jupiterは完全に遠隔操作されており、どこかのチームに、
まあたぶん\mofuppがマウスの動きまで制御していた。
...
あれは運営が処理したのだろうか。
普通に考えて、\mofuppが貴重な得点源をみすみす終了させるわけがない。
